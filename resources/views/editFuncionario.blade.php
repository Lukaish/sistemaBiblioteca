...
<body>
    <x-app-layout>
        ...
        <div class="col-8 m-auto">
            ...
            <br><br><br>
            @php
            $a=$buscarFuncionario->find($buscarFuncionario->id);

            @endphp
            <form name="formCad" id="formCad" method="post" action={{url("funcionarios/$a->id/update")}}>
                @csrf
                @method("PUT")
                ...
                <input class="form-control" type="number" value="{{$a->salario}}" name="salario" id="salario"><br>

                <a href={{url("funcionarios/$a->id/update")}}>
